  ...
  return (
    <Card onClick={() => onEdit(week)} style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 10 }} pad={14}>
      {host ? (
        ...
        <img src="/collective-failure.jpg" alt="" style={{ width: 46, height: 46, borderRadius: '50%', flexShrink: 0, objectFit: 'cover' }} />
      )}
  ...
  return (
    <div style={{ padding: '4px 18px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <PageHead title="The Saga" sub={`${350 + weeks.length} nights and counting...`} />
      </div>
